...
function ___syscall_symlinkat(target, dirfd, linkpath) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(31, 0, 1, target, dirfd, linkpath);
  target >>>= 0;
  linkpath >>>= 0;
  try {
...
var _emscripten_idb_delete = function(db, id, perror) {
  ...
  return Asyncify.handleSleep(wakeUp => {
    IDBStore.deleteFile(UTF8ToString(db), UTF8ToString(id), error => {
      /** @suppress{checkTypes} */ GROWABLE_HEAP_I32()[((perror) >>> 2) >>> 0] = !!error;
      wakeUp();
    });
  });
};
...
var _emscripten_idb_exists = function(db, id, pexists, perror) {
  ...
  return Asyncify.handleSleep(wakeUp => {
    IDBStore.existsFile(UTF8ToString(db), UTF8ToString(id), (error, exists) => {
      /** @suppress{checkTypes} */ GROWABLE_HEAP_I32()[((pexists) >>> 2) >>> 0] = !!exists;
      /** @suppress{checkTypes} */ GROWABLE_HEAP_I32()[((perror) >>> 2) >>> 0] = !!error;
      wakeUp();
    });
  });
...
var _emscripten_idb_load = function(db, id, pbuffer, pnum, perror) {
  ...
  return Asyncify.handleSleep(wakeUp => {
    IDBStore.getFile(UTF8ToString(db), UTF8ToString(id), (error, byteArray) => {
      if (error) {
        GROWABLE_HEAP_I32()[((perror) >>> 2) >>> 0] = 1;
        wakeUp();
        return;
      }
      ...
      GROWABLE_HEAP_U32()[((pbuffer) >>> 2) >>> 0] = buffer;
      GROWABLE_HEAP_I32()[((pnum) >>> 2) >>> 0] = byteArray.length;
      GROWABLE_HEAP_I32()[((perror) >>> 2) >>> 0] = 0;
      wakeUp();
    });
  });
};
...
var _emscripten_idb_store = function(db, id, ptr, num, perror) {
  ...
  perror >>>= 0;
  return Asyncify.handleSleep(wakeUp => {
    IDBStore.setFile(UTF8ToString(db), UTF8ToString(id), new Uint8Array(GROWABLE_HEAP_U8().subarray(ptr >>> 0, ptr + num >>> 0)), error => {
...
function _fd_seek(fd, offset, whence, newOffset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(45, 0, 1, fd, offset, whence, newOffset);
  offset = bigintToI53Checked(offset);
  newOffset >>>= 0;
  try {
    if (isNaN(offset)) return 61;
...
var dynCall_iiidiiiid = Module["dynCall_iiidiiiid"] = createExportWrapper("dynCall_iiidiiiid", 9);
...
var dynCall_vddddddi = Module["dynCall_vddddddi"] = createExportWrapper("dynCall_vddddddi", 8);

var dynCall_vddi = Module["dynCall_vddi"] = createExportWrapper("dynCall_vddi", 4);
...
var dynCall_viddiii = Module["dynCall_viddiii"] = createExportWrapper("dynCall_viddiii", 7);
...
var dynCall_iiiiiiif = Module["dynCall_iiiiiiif"] = createExportWrapper("dynCall_iiiiiiif", 8);
...
var dynCall_viiiiiiiiiddd = Module["dynCall_viiiiiiiiiddd"] = createExportWrapper("dynCall_viiiiiiiiiddd", 13);
...
var dynCall_jiijii = Module["dynCall_jiijii"] = createExportWrapper("dynCall_jiijii", 6);

var dynCall_jiiji = Module["dynCall_jiiji"] = createExportWrapper("dynCall_jiiji", 5);

var dynCall_viiiiiijjii = Module["dynCall_viiiiiijjii"] = createExportWrapper("dynCall_viiiiiijjii", 11);

var dynCall_iiji = Module["dynCall_iiji"] = createExportWrapper("dynCall_iiji", 4);

var dynCall_vijiij = Module["dynCall_vijiij"] = createExportWrapper("dynCall_vijiij", 6);
...
var dynCall_viijiii = Module["dynCall_viijiii"] = createExportWrapper("dynCall_viijiii", 7);
...
var dynCall_vdiiiiiii = Module["dynCall_vdiiiiiii"] = createExportWrapper("dynCall_vdiiiiiii", 9);
...
var dynCall_diiiii = Module["dynCall_diiiii"] = createExportWrapper("dynCall_diiiii", 6);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = Linka_entry;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = Linka_entry;
