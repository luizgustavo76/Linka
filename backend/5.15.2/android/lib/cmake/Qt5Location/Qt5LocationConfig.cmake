...
macro(_populate_Location_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set_target_properties(Qt5::Location PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Location_${ANDROID_ABI}.so"
...
if (NOT TARGET Qt5::Location)
    ...
    set(_Qt5Location_MODULE_DEPENDENCIES "PositioningQuick;Positioning;Quick;Gui;Qml;Network;Concurrent;Core")
    ...
    set(_Qt5Location_LIB_DEPENDENCIES "Qt5::PositioningQuick;Qt5::Positioning;Qt5::Quick;Qt5::Gui;Qt5::Qml;Qt5::Network;Qt5::Concurrent;Qt5::Core")
    ...
    _populate_Location_target_properties(RELEASE "libQt5Location_${ANDROID_ABI}.so" "" FALSE)
